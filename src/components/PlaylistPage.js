      ...
      <div>
        {playlist.movies.map((movie, index) => (
          <div key={index} className="mmmovie-card" style={{ width: 'calc(25% - 16px)', marginRight: '16px', marginBottom: '16px', display: 'inline-block' }}>
            <div className="card" style={{ backgroundColor: '#fff', padding: '16px', borderRadius: '8px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)', height: '350px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
